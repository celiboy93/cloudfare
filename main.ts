// main.ts (v1.22 - FINAL FIX: Added Query Parameter to fix APK Player issues)
import {
  S3Client,
  PutObjectCommand,
  UploadPartCommand,
...
// --- NEW (v1.22) --- Base Query for APK compatibility
const APK_QUERY = '?stream_id=lugyiapk2025';
